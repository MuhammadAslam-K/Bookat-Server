...
exports.default = {
    saveChat: async (data) => {
        try {
            ...
            if (checkChatExists) {
                return await chatRepositoryUpdateQuery_1.default.updateChat(checkChatExists._id, data.message);
            }
            else {
                return await chatRepositorySaveQuery_1.default.createNewChat(data);
            }
            // return true
        }
        catch (error) {
